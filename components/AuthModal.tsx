...
const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div
      ...
      style={{ backgroundColor: 'rgba(30, 41, 58, 0.6)', backdropFilter: 'blur(8px)' }} 
    ...
    >
      <div
        className={`rounded-xl shadow-2xl overflow-hidden w-full sm:max-w-md flex flex-col relative
      ...
      >
        <div className="flex justify-between items-center p-5 border-b" 
          ...
          <button
            onClick={handleCloseWithAnimation}
            className="p-1.5 rounded-full text-white/70 hover:text-white hover:bg-white/20 transition-colors focus:outline-none focus:ring-2 ring-blue-500" // Ring color changed
        ...
        <div className="p-6 overflow-y-auto"> 
          {view === 'login' ? (
            <LoginForm 
              ...
              onGoogleLogin={onGoogleLogin} isLoading={isLoading} error={error}
            />
          ) : (
            <RegisterForm 
